    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link txt-cor txt-cor" href="/admin/banners">Banners</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link txt-cor" href="/admin/artigos">Artigos</a>
                </li>
            </ul>
            {{-- @if (Auth::user()) --}}
            <ul class="navbar-nav mb-2 align-self-end">
                <li class="nav-item dropdown">
                    <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" >Olá Daniel, seja bem vindo</a>
